<header class="header">
  <div class="wrap">
    <div class="header__inner">
      <a <?= ($_SERVER['REQUEST_URI'] == '/') ? '' : 'href = ' . home_url() . '' ?> class="header__logo">
        <img src="/wp-content/themes/smwood/img/logo.png" alt="">
      </a>
      ...
      <div class="header__phones">
        ...
        <a href="tel:+<?php echo get_option('my_phone_second_mob') ?>">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 52.511 52.511" width="22" height="22" fill="#333333">
	        ...
	        <?php echo get_option('my_phone_second') ?>
        </a>
      </div>
    </div>
  </div>
